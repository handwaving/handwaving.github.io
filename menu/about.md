...
**Miscellaneous Notes:**
  ...
  - Related to the above point, Handwaving has a minimal presence on social media. Handwaving has a Twitter account in order to share the comics. That being said, the RSS feed is the best way to stay up to date with the comic. RSS is an open-source technology that *you* curate, not some algorithm that a company comes up with to monetize your eyeballs.
...
One thing I do ask is to link back to the site if you want to use a comic elsewhere. The reason is simple: Handwaving doesn't have much of a social media presence, so it's reliant on links back to the site. By pointing back to here, you're helping others find these comics.
